...
using TickIT.GraphWebhooks.Models;
using TickIT.GraphWebhooks.Services;
using TickIT.GraphWebhooks.SignalR;
...
namespace TickIT.GraphWebhooks.Controllers
{
    /// <summary>
    ...
    public class ListenController : Controller
    {
        ...
        public ListenController(GraphServiceClient graphClient, SubscriptionStore subscriptionStore, CertificateService certificateService, IHubContext<NotificationHub> hubContext, IConfiguration configuration, ILogger<ListenController> logger)
        {
        ...
        private async Task<bool> AreTokensValid(ChangeNotificationCollection notifications, List<Guid> tenantIds, List<Guid> appIds)
        {
